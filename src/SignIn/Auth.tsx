...
import { Avatar, Box, Button, Card, CssBaseline, GlobalStyles, Stack, TextField, Typography } from '@mui/material';
...
function Auth() {
    ...
    useEffect(() => {
        fetch('/api/currentUser').then(r => r.json()).then(async currentUserFromServer => {
